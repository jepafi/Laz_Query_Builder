...
type
  ...
  published
    property DatabaseName:  TZConnection read FZEOSConnection write SetConnection;
  end;
...
begin
  ...
  begin
    ...
    // Contorna bug do zeos 7.0.3 com campos DOUBLE PRECISION em Firebird
